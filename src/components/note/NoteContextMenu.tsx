...
/** 笔记右键菜单（重命名 / 删除）；点击外部或 Esc 关闭，超出窗口时向内收拢 */
export function NoteContextMenu({ state, onRename, onDelete, onClose }: NoteContextMenuProps) {
